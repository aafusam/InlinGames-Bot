...
class StartCommand extends UserCommand
{
    ...
    public function execute(): ServerResponse
    {
        ...
        $text .= __('To Start Playing, Start Inline Message With {USAGE}  Or Click The {BUTTON} Button And Then Select A Chat To Play In. Query❓--> @AafuSamAssistantBot', ['{USAGE}' => '<b>\'@' . $this->getTelegram()->getBotUsername() . ' ...\'</b>', '{BUTTON}' => '<b>\'' . __('Play') . '\'</b>']);
